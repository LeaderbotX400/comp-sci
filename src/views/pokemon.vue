<template>
  <div>
    <div class="welcome-introduction">
      ...
      <p>This is your new Gameboy</p>
      <p>Press START to master your path as Poké-Trainer</p>
    </div>
...
export default {
  beforeCreate: () => {
    document.body.className = "pokemon";
  },
};
</script>
...
.screen {
  ...
  top: 112px;
  left: 282px;
  background-image: url("./images/arena-forrest.png");
...
.item::before {
  content: "";
  background: url("./images/cursor.png"); /*url of image*/
...
.menu {
  ...
  z-index: 2;
  bottom: 0;
  background: url("./images/comment_box_full.jpg");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.menu--overview-box {
  width: 385px;
  height: 100%;
  background: url("./images/menu_box_overview.jpg");
  background-size: contain;
  background-repeat: no-repeat;
  padding: 10px 25px;
}
...
.menu--fight-box {
  ...
  height: 60px;
  display: flex;
  background: url("./images/menu_box_fight.jpg");
  background-size: contain;
  background-repeat: no-repeat;
  padding: 10px 25px;
}
...
.player--stats-box {
  ...
  top: 165px;
  right: 0;
  background: url("./images/player_stats.png");
  width: 200px;
  height: 68px;
  background-size: contain;
  background-repeat: no-repeat;
...
.opponent--stats-box {
  ...
  top: 20px;
  left: 0;
  background: url("./images/opponent_stats.png");
  width: 200px;
  height: 68px;
  background-size: contain;
  background-repeat: no-repeat;
...
.slash:after {
  content: url(./images/slash_1.gif);
  position: absolute;
  left: -140px;
  top: -66px;
  z-index: 0;
...
.opponent--attack-animated:after {
  content: url(./images/opponent-1.gif);
  position: absolute;
  left: -86px;
  top: -110px;
  z-index: 0;
...
.grass:after {
  content: url("./images/leaf_attack.gif");
  position: absolute;
  left: -200px;
  top: -196px;
...
svg.GB .letter.A {
  animation: color 1.6s linear 0.04s both, A-entry 1.6s linear both 0.04s;
}

svg.GB .letter.M {
  animation: color 1.6s linear 0.08s both, M-entry 1.6s linear both 0.08s;
}

svg.GB .letter.E {
  animation: color 1.6s linear 0.12s both, E-entry 1.6s linear both 0.12s;
}

svg.GB .letter.B {
  animation: color 1.6s linear 0.16s both, B-entry 1.6s linear both 0.16s;
}

svg.GB .letter.O {
  animation: color 1.6s linear 0.2s both, O-entry 1.6s linear both 0.2s;
}

svg.GB .letter.Y {
  animation: color 1.6s linear 0.24s both, Y-entry 1.6s linear both 0.24s;
}
